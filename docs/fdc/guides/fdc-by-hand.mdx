...
Once we know the voting round ID, we can go to the `Finalizations` tab of the [Coston2 Systems Explorer](https://coston2-systems-explorer.flare.network/finalizations).
...
<details>
  ...
  <ul>
    <li>
      [Coston](https://coston-systems-explorer.flare.network/finalizations)
    </li>
    <li>
      [Coston2](https://coston2-systems-explorer.flare.network/finalizations)
    </li>
    <li>
      [Songbird](https://songbird-systems-explorer.flare.network/finalizations)
    </li>
    <li>[Flare](https://flare-systems-explorer.flare.network/finalizations)</li>
  </ul>
</details>
