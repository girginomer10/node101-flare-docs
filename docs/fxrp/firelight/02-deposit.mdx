...
2. Update `FIRELIGHT_VAULT_ADDRESS` in `firelight-constants.ts` with the correct vault address for your network.
...
Vault: 0xC90D6847747b85d1fa2E07859869fb9fB72c0361
